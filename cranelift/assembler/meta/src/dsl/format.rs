...
//!
//! ```
//! # use cranelift_assembler_meta::dsl::{fmt, rw, r, Location::*};
...
///
/// ```
/// # use cranelift_assembler_meta::dsl::{OperandKind, Location};
...
///
/// ```
/// # use cranelift_assembler_meta::dsl::{r, rw, Location::r8, Mutability};
...
///
/// ```
/// # use cranelift_assembler_meta::dsl::{Location::r8, sxw, Extension};
