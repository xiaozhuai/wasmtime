...
/// Generate the assembler `file` containing the core assembler logic; each of the DSL-defined
/// instructions is emitted into a Rust `enum Inst`.
...
/// Generate a macro containing builder functions for the assembler's ISLE constructors; this uses
/// the `build` module emitted in [`generate_rust_assembler`].
...
/// Generate the ISLE definitions; this provides ISLE glue to access the builder functions from
/// [`generate_isle_macro`].
